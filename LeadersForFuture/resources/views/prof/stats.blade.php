...
@section('content')
    ...
    <script>
        ...
        const chart = new Chartisan({
            el: '#chart',
            url: "@chart('project_prof')" + "?year=" + year,
        ...
        const chart1 = new Chartisan({
            el: '#chart1',
            url: "@chart('status_year_prof')" + "?year=" + year + "-1",
            hooks: new ChartisanHooks()
        ...
        function updateChart(year) {
            chart.update({url: "@chart('project_prof')" + "?year=" + year})
        }

        function updateChart1(year, sem) {
            chart1.update({url: "@chart('status_year_prof')" + "?year=" + year + "-" + sem})
        }
    </script>
@endsection
